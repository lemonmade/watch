...
export interface App {
    ...
    hasSecret(variables: Record<string, never>): boolean;
    userDetailsJWT(variables: Record<string, never>): string | null;
}
...
export interface CreateAppSecretPayload {
    ...
    app(variables: Record<string, never>): App | null;
    secret(variables: Record<string, never>): string | null;
}
...
export interface Schema {
    ...
    CreateAppSecretPayload: CreateAppSecretPayload;
