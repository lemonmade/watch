...
export interface User {
    ...
    webAuthnCredentials(variables: Record<string, never>): WebAuthnCredential[];
...
export interface Mutation {
    ...
    startWebAuthnRegistration(variables: Record<string, never>): StartRegistrationPayload;
    createWebAuthnCredential(variables: {
        readonly credential: JSON;
    }): CreateWebAuthnCredentialPayload;
    deleteWebAuthnCredential(variables: {
        readonly id: string;
    }): DeleteWebAuthnCredential;
    startWebAuthnSignIn(variables: {
        readonly email?: string | null;
    }): StartWebAuthnSignInPayload;
    completeWebAuthnSignIn(variables: {
        readonly credential: JSON;
    }): CompleteWebAuthnSignInPayload;
...
export interface StartRegistrationPayload {
    __typename: "StartRegistrationPayload";
    result(variables: Record<string, never>): JSON;
}
export interface CreateWebAuthnCredentialPayload {
    __typename: "CreateWebAuthnCredentialPayload";
    credential(variables: Record<string, never>): WebAuthnCredential | null;
    user(variables: Record<string, never>): User;
}
export interface DeleteWebAuthnCredential {
    __typename: "DeleteWebAuthnCredential";
    deletedCredentialId(variables: Record<string, never>): string;
    user(variables: Record<string, never>): User;
}
export interface StartWebAuthnSignInPayload {
    __typename: "StartWebAuthnSignInPayload";
    result(variables: Record<string, never>): JSON;
}
export interface CompleteWebAuthnSignInPayload {
    __typename: "CompleteWebAuthnSignInPayload";
...
export interface Schema {
    ...
    StartRegistrationPayload: StartRegistrationPayload;
    CreateWebAuthnCredentialPayload: CreateWebAuthnCredentialPayload;
    DeleteWebAuthnCredential: DeleteWebAuthnCredential;
    StartWebAuthnSignInPayload: StartWebAuthnSignInPayload;
    CompleteWebAuthnSignInPayload: CompleteWebAuthnSignInPayload;
