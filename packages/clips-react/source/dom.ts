  ...
  createElement(type: string): ComponentElementForRemote {
    ...
    > = {
      ...
      set textContent(content: string) {
        ...
        baseElement.appendChild(document.createTextNode(content) as any);
      },
      ...
      addEventListener(event: string, func: any, _options?: any) {
