...
export interface ClipsExtensionPointPreview {
  ...
  url(variables: {readonly connect?: boolean | null}): Url;
}
...
export interface ClipsExtensionPointLoadingUi {
  ...
  file(variables: Record<string, never>): string;
  tree(variables: Record<string, never>): ExtensionLoadingUiTree;
  html(variables: Record<string, never>): ExtensionLoadingUiHtml;
}
...
export interface ClipsExtensionPointSupport {
  ...
  liveQuery(
    variables: Record<string, never>,
  ): ClipsExtensionPointLiveQuery | null;
...
export interface App {
  ...
  extension(variables: {readonly id: string}): Extension | null;
  clipsExtension(variables: {readonly id: string}): ClipsExtension | null;
}
